...
define('CON_TEST_BASENAME', basename(__DIR__, 2));
...
if (file_exists(__DIR__ . '/defines.local.php')) {
    include_once __DIR__ . '/defines.local.php';
}
if (!defined('CONTENIDO_INSTALLATION_PATH')) {
    throw new Exception('Could not detect constant CONTENIDO_INSTALLATION_PATH, is file defines.local.php missing?');
}

$_backendDir = CONTENIDO_INSTALLATION_PATH . '/contenido';
$_frontendDir = CONTENIDO_INSTALLATION_PATH . '/cms';
...
require_once CON_TEST_PATH . '/setup/cUnitTestSession.php';
...
require_once $_backendDir . '/plugins/mp_dev_tools/includes/config.plugin.php';
